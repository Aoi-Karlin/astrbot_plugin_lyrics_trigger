...
1. 部署 [NeteaseCloudMusicApiEnhanced](https://github.com/neteasecloudmusicapienhanced/api-enhanced) 服务
...
### 网易云API地址
- **说明**：NeteaseCloudMusicApiEnhanced服务的地址
...
## 额外使用提示
- 本插件使用的匹配方法比较原始（指直接在网易云API搜歌词），所以准确性不一定高。
